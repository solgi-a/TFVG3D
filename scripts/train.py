...
def get_solver(args, dataloader):
    ...
    if args.use_checkpoint:
        ...
        state_dict = torch.load(os.path.join(CONF.PATH.OUTPUT, args.use_checkpoint, "model.pth"))
...
def train(args):
    ...
    # dataloader
    train_dataset, train_dataloader = get_dataloader(args, scanrefer, all_scene_list, "train", args.device, not args.no_augment)
    val_dataset, val_dataloader = get_dataloader(args, scanrefer, all_scene_list, "val", args.device, False)
    dataloader = {
...
if __name__ == "__main__":
    ...
    parser.add_argument("--no_augment", action="store_true", help="Do NOT augment.")
